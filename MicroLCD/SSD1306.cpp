...
const uint8_t PROGMEM buf_init128x32[] = {
	...
	0x8F,								   // SSD1306_SWITCHCAPVCC
	SSD1306_SETPRECHARGE,                  // 0xd9
	0xF1,								   // SSD1306_SWITCHCAPVCC
...
const uint8_t PROGMEM buf_init128x64[] = {
	SSD1306_DISPLAYOFF,                    // 0xAE
	SSD1306_SETDISPLAYCLOCKDIV,            // 0xD5
	0x80,                                  // the suggested ratio 0x80
	SSD1306_SETMULTIPLEX,                  // 0xA8
...
void SSD1306::begin(uint8_t vccstate, uint8_t i2caddr) {
  ...
  // turn on VCC (9V?)
  	  ...
  	  ssd1306_command_stream((uint8_t *)buf_init128x32, sizeof(buf_init128x32));
  #endif
...
//    ssd1306_command_stream((uint8_t *)buf_init128x64, sizeof(buf_init128x64));
  #endif
...
void SSD1306::ssd1306_command_stream(uint8_t *c, uint8_t size) {
    // I2C
	for(; size>0; size--)
		ssd1306_command(*c++);
}
